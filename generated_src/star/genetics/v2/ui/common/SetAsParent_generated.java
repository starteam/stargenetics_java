...
abstract class SetAsParent_generated extends star.genetics.v2.ui.common.Button implements star.event.EventController, star.event.Listener, star.genetics.v1.ui.events.OrganismSetAsParentRaiser
{
	...
	private void eventRaisedHandles(final star.event.Event event)
	{
		if (event.getClass().getName().equals("star.genetics.v1.ui.events.CrateMateEvent") && event.isValid())
		{
			...
			{
				System.out.println(this.getClass().getName() + ".crateMated " + (end - start) / 1000000);
			}
		}
