...
abstract class Applet_generated extends javax.swing.JApplet implements star.event.EventController, star.event.Listener, star.genetics.events.ErrorDialogRaiser, star.genetics.events.OpenModelRaiser
{
	...
	java.util.prefs.Preferences getPreferences()
	{
		if (preferences == null)
		{
			...
			{
				plugin.preferences.Preferences pref = (plugin.preferences.Preferences) plugin.Loader.getDefaultLoader().getPlugin(plugin.preferences.Preferences.class.getName(), plugin.preferences.PreferencesImplementation.class.getName());
				this.preferences = pref.getPreferences("star.genetics.v2.ui.Applet");
			}
			catch (plugin.PluginException ex)
			{
				ex.printStackTrace();
		...
		if (preferences == null)
		{
			return java.util.prefs.Preferences.userRoot().node("star.genetics.v2.ui.Applet");
		}
		return preferences;
	}
