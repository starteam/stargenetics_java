...
public class GenotypeList2X extends JPanel
{
	private static final long serialVersionUID = 1L;
	private final static String[] data = new String[] { "XX", "Xx", "xx" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	private final static String[] dataB = new String[] { "BB", "Bb", "bb" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

	private JList list1;
	private JList list2;

	public GenotypeList2X(String title)
	{
