...
public class WebSamples extends WebSamples_generated
{
	...
	private String getAlternateText()
	{
		...
		try
		{
			...
			text = new String(FileUtils.getStreamToByteArray(samplesURL.openStream()), Charset.forName("UTF-8"));
		}
		catch (Throwable t2)
		{
			samplesURL = null;
	...
	private String getText()
	{
		...
		try
		{
			...
			text = new String(FileUtils.getStreamToByteArray(c.getInputStream()), Charset.forName("UTF-8"));
		}
		catch (Throwable t)
		{
